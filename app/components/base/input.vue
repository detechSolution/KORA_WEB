...
<template>
  ...
  >
    <UTextarea
      ...
      size="lg"
      :ui="{
        base: 'bg-white dark:bg-transparent resize-none ring-secondary-50 dark:ring-secondary-800 focus:ring-1 focus:outline-none placeholder:text-secondary-300 rounded-xs',
      }"
    />
    <UInput
      v-else
